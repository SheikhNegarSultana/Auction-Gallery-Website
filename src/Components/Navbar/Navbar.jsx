        ...
        <div className=' margin-style mt-[1rem]'>
            ...
            <div className="navbar bg-base-100 ">
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1 font-normal text-[1rem]">
                        <li><a>Home</a></li>
                        <li><a>Auctions</a></li>
                ...
                <div className="navbar-end">
                    <button className="flex items-center gap-[1rem]">
                        ...
                        <div className="indicator">
                            ...
                            className="h-[1.7rem] w-[1.7rem] btn btn-ghost btn-circle p-[0.01rem] bg-[#EBF0F5] " 
                            role="button"
                            fill="none" 
                            viewBox="0 0 24 24" 
                            stroke="currentColor"> 
                            ...
                            <span className="badge badge-sm bg-black text-white indicator-item">9</span>
                        </div>
